  ...
  <div>
    <div class="contain-title">
      ...
      <div class="title-text">
        <div class="title-text-left">
          <p>厂商名称</p><input v-model="listQuery.name" class="equiinput" type="text">
          <p  class="text-data">厂商编号</p><input v-model="listQuery.code" class="equiinput" type="text">
        </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-form class="small-space" :model="temp" :rules="rules" ref="temp" label-position="left" label-width="95px"
        ...
        <el-form-item label="厂商编号" prop="code">
...
<script>
  import {getmanufacturer,manufactureradd,getmanufaone,manufacturerput,manufacturerdelete} from "../api/getlist"
    ...
    methods: {
      ...
      update(){
        ...
        this.$refs.temp.validate(valid=>{
          if (valid) {
            manufacturerput(this.temp).then(res=>
              {
      ...
      create(formName){
        ...
        this.$refs.temp.validate(valid=>{
          if (valid) {
            manufactureradd(self.temp).then(res =>{
              if(JSON.parse(res.data).code==1){
      ...
      alldelete(){
        ...
        this.$confirm('确认删除这些记录吗?', '提示', {
          ...
          manufacturerdelete(ids).then(function (response) {
      ...
      handleDelete(index){
        ...
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          manufacturerdelete(index).then(function (response) {
          let rmsg=JSON.parse(response.data);
          if(rmsg.code == 1){
            self.loadData();
          }else{
